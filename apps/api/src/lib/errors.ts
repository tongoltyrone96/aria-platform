...
export const Errors = {
  ...
  callLimitExceeded: (retryAfter?: string) => new ApiError(429, 'ERR_CALL_LIMIT_EXCEEDED', { retryAfter }),
  answerLimitExceeded: (limit: number) => new ApiError(429, 'ERR_ANSWER_LIMIT_EXCEEDED', { limit }),
