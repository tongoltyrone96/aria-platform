...
const testimonials = [
  ...
  },
  {
    ...
    company: 'Career change from Teaching',
  ...
  },
  {
    ...
    company: 'New grad, hired at Shopify',
  ...
  },
  {
    name: 'Sophie Leblanc',
    role: 'UX Designer',
    company: 'Career change from Finance',
  ...
  return (
    <section id="testimonials" className="py-24">
      <div className="container mx-auto max-w-6xl px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Real People. Real Offers.</h2>
