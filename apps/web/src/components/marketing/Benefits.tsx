...
const useCases = [
  ...
  },
  {
    ...
    description:
      'Stepping into a new industry means facing questions you have never rehearsed. Aria reframes your existing experience into compelling, role-relevant answers that land.',
    image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600',
  },
  {
    title: 'New Graduates',
    description:
      'Turn limited experience into a winning story. Aria coaches you through live interviews and practice sessions so you walk into your first big opportunity fully prepared.',
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="space-y-4">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-normal">
