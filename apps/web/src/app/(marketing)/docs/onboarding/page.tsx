...
export default function OnboardingPage() {
  return (
    <article className="space-y-6">
      ...
      <p>
        Head to your <a href="/dashboard" className="text-brand-500 hover:underline">Dashboard</a> and click
        <strong> Download ARIA for Windows</strong>. Run the installer and follow the prompts.
        See the <a href="/docs/install" className="text-brand-500 hover:underline">Installation guide</a> for detailed steps.
      </p>
      ...
      <p>
        ...
        or from the <strong>Licenses</strong> section of your dashboard.
        See <a href="/docs/license-activation" className="text-brand-500 hover:underline">License Activation</a> for details.
      </p>
      ...
      <p>
        For detailed audio setup see the <a href="/docs/wasapi-setup" className="text-brand-500 hover:underline">WASAPI Setup guide</a>.
      </p>

      <h2 className="text-xl font-semibold">6. Add your resume and job description</h2>
      <p>
        Go to the <strong>Profile</strong> tab inside ARIA. Upload your resume (PDF or DOCX) and paste in the
        job description for the role you are interviewing for. ARIA uses this context to generate
        highly relevant, personalised answers.
      </p>

      <h2 className="text-xl font-semibold">7. Run your first session</h2>
      <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
        <li>Click <strong>Start Session</strong> in ARIA.</li>
      ...
      <div className="bg-brand-500/5 border border-brand-500/20 rounded-xl p-4 text-sm">
        <strong>Tip:</strong> Rehearse with ARIA before your real interview by doing a mock session with a friend or
        by replaying recorded interviews.
      </div>

      <h2 className="text-xl font-semibold">Next steps</h2>
      <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
        <li><a href="/docs/wasapi-setup" className="text-brand-500 hover:underline">Fine-tune audio capture</a></li>
        <li><a href="/docs/troubleshooting" className="text-brand-500 hover:underline">Troubleshooting common issues</a></li>
        <li><a href="/docs/faq" className="text-brand-500 hover:underline">Frequently asked questions</a></li>
      </ul>
    </article>
  );
}
