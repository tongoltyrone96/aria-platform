    ...
    <section className="py-24">
      <div className="container mx-auto max-w-6xl px-4">
        <motion.h2
          ...
          className="text-3xl md:text-4xl lg:text-5xl mb-16 text-center"
        >
          ...
          <div className="flex items-center py-2"
            ...
            {doubled.map((platform, i) => (
              <div key={i} className="flex items-center gap-3 whitespace-nowrap pr-14">
                <div className="w-14 h-14 rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "#F05A28" }}>
                  <span className="w-6 h-6 text-white flex items-center justify-center [&>svg]:w-6 [&>svg]:h-6 [&>svg]:fill-white">
                    {platform.icon}
                  </span>
                </div>
